...
get_tests_for_category() {
    ...
    case "$category" in
        ...
        maven)
            ...
            ;;
        security)
            echo "test-security-no-root.sh test-agent-id-unique.sh test-env-api-keys.sh test-container-libs.sh test-ssh-keychain.sh test-keychain-retrieval.sh test-ssh-cache-cleanup.sh test-keychain-platform.sh test-config-security.sh test-network-isolation.sh test-scope-validation.sh test-sanitize-files.sh"
            ;;
        git)
            echo "test-git-new-branch.sh test-git-auto-commit-push.sh test-worktree-isolation.sh test-push-verification.sh test-git-excludes.sh test-validate-staged-files.sh test-coauthor-fork.sh test-post-container-git.sh"
            ;;
        cleanup)
        ...
        integration)
            ...
            ;;
        libs)
            echo "test-compat.sh test-logging.sh test-json-utils.sh test-git-remote-utils.sh test-progress-display.sh test-atomic-copy.sh test-snapshot-staging.sh test-git-operations.sh test-config-resolver.sh test-env-builder.sh test-volume-mounts.sh"
            ;;
        hooks)
