...
### Fixed
- Add managed container git transport policy (#471)
...
### Fixed
- Prevent and detect /kapsis-status virtio-fs failures (#276) (#280)


### Changed
- Fix all critical/high dependency issues from audit (#268)
...
[Unreleased]: https://github.com/aviadshiber/kapsis/compare/v3.3.2...HEAD
[3.3.2]: https://github.com/aviadshiber/kapsis/releases/tag/v3.3.2
...
[2.21.5]: https://github.com/aviadshiber/kapsis/releases/tag/v2.21.5
